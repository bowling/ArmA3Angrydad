	...
	class ExileNonVeganFood
	{
		name = "Exile Non-Vegan Food";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"Exile_Item_CatSharkFilet_Raw",
	...
	class ExileNavigation
	{
		name = "Exile Special Environment";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
	...
	class ExileAmmunition
	{
		name = "Exile Ammunition";
	...
	class ExileLightMachineGuns
	{
		name = "Exile Light Machine Guns";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"Exile_Weapon_RPK",
	...
	class ExileSniperRifles
	{
		name = "Exile Sniper Rifles";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"Exile_Weapon_CZ550",
